...
// 2. Récupérer toutes les notes groupées par semestre
$query = "
...
// 3. Organiser les notes par semestre et calculer les moyennes
$semestres = [1 => [], 2 => []];
$stats = [
...
<div class="main-content">
    ...
    <div class="profile-card glass-effect" style="margin-bottom: 30px;">
        <div class="info">
            <h2 style="color: #2c3e80; margin-bottom: 15px;">Moyenne Annuelle</h2>
            <p><strong>Année Universitaire :</strong> 2025/2026</p>
            <p><strong>Niveau :</strong> <?= htmlspecialchars($etudiant['niveau']) ?></p>
        </div>
        
        <div class="moyenne-box" style="background: white; border-color: #2c3e80;">
            <?php if ($moy_annuelle !== null): ?>
                <div class="value" style="font-size: 32px; color: #2c3e80;"><?= number_format($moy_annuelle, 2) ?></div>
                        ...
                        <?php if (!empty($semestres[1])): ?>
                            <?php foreach ($semestres[1] as $n): ?>
                                <tr>
                                    ...
                                    <td><?= $n['coefficient'] ?></td>
                                    <td style="color: <?= $n['note'] >= 10 ? '#28a745' : '#dc3545' ?>; font-weight: 600;">
